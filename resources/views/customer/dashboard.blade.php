...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .user-info-name  { font-size: 13px; font-weight: 600; color: rgba(255,255,255,0.8); }
        .user-info-role  { font-size: 11px; color: rgba(255,255,255,0.3); margin-top: 1px; }
        ...
        .topbar-notif-btn:hover { background: #eff6ff; border-color: #bfdbfe; }
        .notif-badge {
            position: absolute;
            top: 6px; right: 6px;
        ...
        .stat-label { font-size: 11px; font-weight: 600; color: var(--slate); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 8px; }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/customer/dashboard"
         ...
         <a href="/main"
           class="nav-link {{ Request::is('main') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/>
                <rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>
            </svg>
        ...
        <a href="/customer/orders"
           class="nav-link {{ Request::is('customer/orders') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path d="M20 7H4a1 1 0 00-1 1v10a1 1 0 001 1h16a1 1 0 001-1V8a1 1 0 00-1-1z"/><path d="M16 3H8l-1 4h10z"/>
            </svg>
            My Orders
        </a>
